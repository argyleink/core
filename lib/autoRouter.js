      ...
      if ( found === true ) {
        ...
        if (typeof controller[action] === 'function') {
          ...
          try {
            ...
            if (app.config.engines.html.template === 'nunjucks') {

              console.log(' ');
              console.log('# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #'.red);
              console.log('        AW SCHUCKS, YOUR CONTROLLER FAILED TO LOAD!');
              console.log('# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #'.red);
              console.log('It looks like you\'re using nunjucks. REMEMBER that nunjucks');
              console.log('requires that you us the .nj extension when loading a view.');
              console.log('For example:');
              console.log(' ');
              console.log('  ' + '  yield view.render(\'index.nj\', {  '.bgRed.white);
              console.log('  ' + '    title : \'Hello World\'          '.bgRed.white);
